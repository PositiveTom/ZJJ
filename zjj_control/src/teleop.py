...
For Holonomic mode (strafing), hold down the shift key:对于扫射模式，按住shift键
---------------------------
   U    I    O
   J    K    L
   M    <    >
...
w/x: shift the middle pos of throttle by +/- 5 pwm 转移油门的中间位置
a/d: shift the middle pos of steering by +/- 2 pwm 改变转向的中间位置
CTRL-C to quit
"""
    ...
    try:
        while(1):
            ...
            if key in moveBindings.keys():
                ...
                if(speed_dir!=0 and speed_dir + last_speed_dir == 0):#Reverse,speed_dir
                    control_speed = speed_mid                 
